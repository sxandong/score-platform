...
from sqlalchemy import (
    Column, BigInteger, String, Integer, Date, Boolean,
...
class Score(Base):
    ...
    entered_by = Column(BigInteger, ForeignKey("users.id"), nullable=False)
...
class ScoreDetail(Base):
    ...
    id = Column(BigInteger, primary_key=True, autoincrement=True)
    score_id = Column(BigInteger, ForeignKey("scores.id", ondelete="CASCADE"), nullable=False)
